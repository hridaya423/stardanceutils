(() => {
  ...
  SU.getBaseCommandPaletteUtilityCommands = () => [
    ...
    {
      id: 'enable-shop-orders-sidebar',
      title: 'Keep Your Orders In Sidebar',
      keywords: 'shop orders sidebar enable keep rail',
      showWhenEmpty: false,
      run: () => SU.setCommandPaletteShopOrdersEnabled(true)
    },
    {
      id: 'disable-shop-orders-sidebar',
      title: 'Move Your Orders Out Of Sidebar',
      keywords: 'shop orders sidebar disable main area button',
      showWhenEmpty: false,
